...
-- Beispiel-Daten
INSERT INTO notes (title, transcript, summary, audio_duration, audio_path, status) VALUES
    (
        'Meeting mit Team',
        ...
        327,
        '/uploads/audio/meeting-team-2025-11-15.mp3',
        'completed'
    ),
    (
        'Einkaufsliste',
        ...
        45,
        '/uploads/audio/einkaufsliste-2025-11-14.mp3',
        'completed'
    ),
    (
        'Projektideen',
        ...
        158,
        '/uploads/audio/projektideen-2025-11-13.mp3',
        'completed'
    );
